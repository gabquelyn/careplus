...
const PILLARS_LIST: PillarItem[] = [
  {
    ...
    description:
      "Remaining in the environment that holds your memories, treasures, and comforts is vital to emotional well-being.",
    icon: (
      <svg
        className="h-6 w-6"
        fill="none"
  ...
  },
  {
    title: "Independence",
    description:
      "Our caregivers assist with essential daily tasks while actively empowering your loved one to retain control over their routines.",
    icon: (
      <svg
        className="h-6 w-6"
        fill="none"
  ...
  },
  {
    title: "Dignity",
    description:
      "Every physical, clinical, or social intervention we make is handled with complete privacy, empathy, and absolute respect.",
    icon: (
      <svg
        className="h-6 w-6"
        fill="none"
  ...
  },
  {
    ...
    description:
      "We help keep your loved ones active, healthy, and deeply integrated within their neighborhood and social circles.",
    icon: (
      <svg
        className="h-6 w-6"
        fill="none"
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="max-w-3xl mb-16">
          ...
          <p className="mt-4 text-lg text-warm-grey">
            We focus on maintaining routines and preserving meaningful physical
            and social bonds.
          </p>
        </div>
